...
SYSTEM_COMMANDS = ['read', 'send','delete', 'exit']
MY_CONTACTS = []
...
def security_email_system(username='ns201test@gmail.com', password='eranroyshir'):
    ...
    while True:
        click.echo(Fore.LIGHTBLUE_EX+'<secure email> Please choose option:\n'
                   ...
                   '               3) Enter \'delete\' for deleting your mailbox\n'
                   '               4) Enter \'exit\' for exit the system\n ')
        prompt = input()
